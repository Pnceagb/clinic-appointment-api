...
class AppointmentCreate(BaseModel):
    ...
    appointment_time: str = Field(..., pattern=r"^([01]\d|2[0-3]):[0-5]\d$", examples=["09:30"])
...
class AppointmentUpdate (BaseModel):
    ...
    appointment_time: Optional[str] = Field(None, pattern=r"^([01]\d|2[0-3]):[0-5]\d$", examples=["09:30"])
